...
#
# @param kafka_jvm_performance_options
...
class kafka_connect (
  ...
  Stdlib::HTTPUrl                   $archive_source                      = 'https://downloads.apache.org/kafka/3.9.2/kafka_2.13-3.9.2.tgz',

  # kafka_connect::config
  Enum['distributed', 'standalone'] $config_mode                         = 'distributed',
  String[1]                         $kafka_heap_options                  = '-Xms256M -Xmx2G',
  Optional[String[1]]               $kafka_jvm_performance_options       = undef,
